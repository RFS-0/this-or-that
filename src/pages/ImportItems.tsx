...
import {Icon, TonalButton} from '../design-system'
                        ...
                        >
                            <div class="p-1.5 min-w-full inline-block align-middle">
                                <div class="border border-outline-variant rounded-f7 overflow-hidden">
                                    <table
                                        class="border-collapse min-w-full max-w-full divide-y divide-outline-variant">
                                        <thead class="bg-outline-variant">
                                        <tr>
                                            <th scope="col" class="p-f6 text-left text-on-surface-variant">Title</th>
                                            <th scope="col" class="p-f6 text-left text-on-surface-variant">Description
                                            </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <ButtonCell id={`remove-${intendedItem.id}`}>
                                                        <TextButton
                                                            ...
                                                            leadingIcon={
                                                                <Icon><span
                                                                    class="material-symbols-outlined">delete</span></Icon>
                                                            }
